...
```
✅ 디자인(피그마)를 참고하여 모든 페이지의 UI 구현
✅ 한 명당 한 페이지의 작업은 필수 입니다.
...
- UI: Splash 페이지, 로그인페이지, footer 컴포넌트 , 프로필 수정 페이지, 상품등록 패아자, 게시물등록 페이지
- 구현기능: Splash screen 기능, 하단탭 활성화 기능, 내 프로필 수정기능, 상품등록 기능
- 그외: README 작성, 메인보드 관리

<br>

## 🧑🏻‍💻 박소현 - `코드 리더`

- UI: 회원가입페이지, header 컴포넌트, 프로필(내프로필,상대프로필), 피드, 검색, 댓글 보이는 포스트
- 기능 구현: 검색기능, 사용자 프로필 페이지, 게시글 작성 페이지, 채팅방
