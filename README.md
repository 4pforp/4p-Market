...
| :-------------------------------------------------------------------------: | :-------------------------------------------------------------------------: |
| <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/K5sjaWEAHC.gif"/> | <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/Le4ROe50xu.gif" /> |

|                                  2. 로그인                                  |                                 3. 로그아웃                                 |
| :-------------------------------------------------------------------------: | :-------------------------------------------------------------------------: |
| <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/xOhP7okwEx.gif" /> | <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/Dn13ERfKIR.gif" /> |

|                                 4. 홈 피드                                  |                                5. 계정 검색                                 |
| :-------------------------------------------------------------------------: | :-------------------------------------------------------------------------: |
| <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/VLNhAuI5QP.gif"/> | <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/U8o8HAVRjh.gif" /> |

|                            6. 마이 프로필 페이지                            |                            6-1. 마이 프로필 수정                            |
| :-------------------------------------------------------------------------: | :-------------------------------------------------------------------------: |
| <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/svLwT1TN4A.gif"/> | <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/RZBSIaKSi9.gif" /> |

|                               7. 유저 프로필                                |                        8. 댓글 등록 / 삭제 / 좋아요                         |
| :-------------------------------------------------------------------------: | :-------------------------------------------------------------------------: |
| <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/Obw5hrvJLU.gif" /> | <img width="300" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/XzLQoynnUG.gif" /> |

|                                9. 게시물 등록                                 |                               9-1. 게시글 수정                                |                               9-2. 게시글 삭제                                |
| :---------------------------------------------------------------------------: | :---------------------------------------------------------------------------: | :---------------------------------------------------------------------------: |
| <img width="300px;" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/5EMj5xakd8.gif"> | <img width="300px;" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/aBFkzSSdtG.gif"> | <img width="300px;" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/p8R3YFo269.gif"> |

|                                 10. 상품 등록                                 |                             10-1. 상품 등록 수정                              |                                10-2. 상품 삭제                                |
| :---------------------------------------------------------------------------: | :---------------------------------------------------------------------------: | :---------------------------------------------------------------------------: |
| <img width="300px;" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/oEYxjznqV3.gif"> | <img width="300px;" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/k2ypXlinOO.gif"> | <img width="300px;" src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/m1v8QseAC3.gif"> |
...
- Custom Hook 
    - 삭제, 신고, 이미지 예외처리 로직 custom hooks 생성
    - 반복되는 메소드들을 줄여줌으로써 불필요한 코드 제거
...
2. 디테일한 예외처리 
- 사용자 예외처리, 라우터 예외처리, 에러이미지 예외처리

3. 빠른 작업 방식
- 작업하면서 폴더트리 구조화, 컨벤션 디벨롭

4. 커뮤니케이션 
- 실시간으로 소통하면서 작업
- 정기 회의를 진행하면서 언젠든지 회의를 요청 할 수 있는 팀 문화
- 오늘 할일 채널
- 메인보드, 작업관리 현황표 사용
```
<br>
