...
- 로그인 페이지 (API 명세에 따름)
  ...
  - 페이지 진입 시 인풋창 포커스 기능 추가 구현
    - 인풋창을 클릭하지 않아도 input 창이 활성화되게끔 UX 측면 고려하여 구현
...
- 에러 페이지
  ...
  - 잘못된 주소 입력 시 에러페이지 띄우도록 구현
  - 페이지에 두 가지 버튼(이전 페이지로 이동, 홈으로 이동)을 만들어 사용자 이동 편의성 고려
...
|                                  2. 로그인                                  |                           3. 홈 화면, 무한스크롤                            |
| :-------------------------------------------------------------------------: | :-------------------------------------------------------------------------: |
| <img src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/xOhP7okwEx.gif" width="300"/> | <img src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/GTp6LnN7r7.gif" width="300"/> |

|                                4. 계정 검색                                 |                                   5. 채팅                                   |
| :-------------------------------------------------------------------------: | :-------------------------------------------------------------------------: |
| <img src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/U8o8HAVRjh.gif" width="300"/> | <img src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/FkViWg1mOe.gif" width="300"/> |
...
| :-------------------------------------------------------------------------: | :-------------------------------------------------------------------------: |
| <img src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/oEYxjznqV3.gif" width="300"/> | <img src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/k2ypXlinOO.gif" width="300"/> |
...
|                             11. 팔로잉, 팔로우                              |                                12. 로그아웃                                 |
| :-------------------------------------------------------------------------: | :-------------------------------------------------------------------------: |
| <img src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/x2wHAvFVgz.gif" width="300"/> | <img src="https://i.esdrop.com/d/f/eZ1kpS3Y3y/Dn13ERfKIR.gif" width="300"/> |
